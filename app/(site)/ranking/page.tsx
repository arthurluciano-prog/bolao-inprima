          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50 text-[11px] uppercase tracking-wide text-gray-500">
                ...
                <th className="px-3 py-2 text-center">Ex.</th>
                <th className="px-3 py-2 text-center">Ven.</th>
              </tr>
            </thead>
            <tbody>
              {ranking.map((p, i) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-center text-success-text">{p.exatos}</td>
                  <td className="px-3 py-2.5 text-center text-winner-text">{p.vencedor}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <div className="fixed inset-x-0 bottom-0 z-40 max-h-[82vh] overflow-y-auto rounded-t-[20px] bg-white p-5 shadow-2xl">
            ...
            <div className="mb-5 grid grid-cols-3 gap-2">
              <div className="rounded-card bg-primary p-3 text-center">
                ...
                <p className="mt-1 text-[10px] font-semibold uppercase tracking-wide text-white/70">Pontos</p>
              </div>
